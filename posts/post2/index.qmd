...
while a **probability greater than 0.5** predicts it as 1 (True).  
For example, if $\beta_1 = 0.8$, it means that for every 1-unit increase in $X_1$, 
...
splitting data into branches based on conditions.
...
In practice, the choice between logistic regression and decision trees often comes down to the specific needs of the clinical application—whether interpretability or model flexibility is more important—and the nature of the data at hand.
